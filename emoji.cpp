...
Emoji::Emoji(const QStringList &n, const QString &u, const QString &a,
             const QStringList &v)
    : m_n{n}, m_u{u}, m_a{a}, m_v{v} {}

QStringList Emoji::n() const { return m_n; }

QString Emoji::u() const { return m_u; }

QString Emoji::a() const { return m_a; }

QStringList Emoji::v() const { return m_v; }
