...
class EmojiDataProvider : public QObject {
  Q_OBJECT
  Q_PROPERTY(
      QString keyword READ keyword WRITE setKeyword NOTIFY keywordChanged FINAL)
...
public:
  Q_INVOKABLE QList<Emoji> getEmojisByCategory(const QString &category,
                                               const QString &keyword = "");
  Q_INVOKABLE Emoji getEmojiByCategoryAndCodePoint(const QString &category,
